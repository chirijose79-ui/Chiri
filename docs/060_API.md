...
AUTH_INVALID_ACCESS_TOKEN
        |
        +-- Access token ausente, inválido,
            expirado o asociado a una sesión no válida

AUTH_INVALID_REFRESH_TOKEN
        |
        +-- Refresh token inexistente, inválido,
            expirado, revocado o asociado a una sesión no válida
...
podrá utilizarse cuando un servicio requerido por la operación no se encuentre disponible y la solicitud no pueda completarse.
