...
La arquitectura podrá utilizar autenticación basada en tokens.
...
Servidor entrega token

        |

Cliente utiliza token en solicitudes posteriores
```
...
* mantener seguridad.
* evitar pedir credenciales constantemente.
...
# 6.5 Modelo de Respuesta Estándar
