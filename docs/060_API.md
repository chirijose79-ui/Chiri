...
Todas las respuestas de error de la API deberán utilizar la siguiente estructura:
...
se utilizará cuando los datos proporcionados por el cliente no cumplan las reglas de validación definidas por el contrato del endpoint.
...
# 11 Rutas actualmente implementadas
...
Una autenticación exitosa crea una nueva sesión y devuelve las credenciales asociadas.
...
El endpoint está implementado mediante el router de autenticación del Backend.
...
No devuelve credenciales ni secretos.
...
La operación revoca la sesión asociada al access token.
...
Las rutas relacionadas con usuarios, dispositivos, multimedia, domótica, administración, roles, permisos y demás capacidades de Chiri Platform deberán considerarse futuras hasta que sean implementadas y probadas en el Backend.
