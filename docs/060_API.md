...
Los valores anteriores representan el diseño conceptual del token.

Los nombres y claims definitivos deberán mantenerse consistentes con la implementación del servicio de autenticación.
